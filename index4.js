    ...
    <html>
      <head>
        ...
        <style>
          ...
          body { font-family: 'Roboto', sans-serif; color: #333; } /* Changed to Roboto */
          h1, h3 { color: #6a1b9a; } /* Light Purple for headings */
          .lead { font-size: 1.1rem; color: #555; }
          .bg-light { background-color: #f3e5f5 !important; } /* Light purple background */
        </style>
      </head>
      <body>
